  ...
  return (
    ...
    >
      <Menu visible={visible} onDismiss={closeMenu}  anchor={<IconButton icon="cog" iconColor={"white"} size={30} onPress={openMenu}/>}>
        <Menu.Item onPress={() => {navigation.navigate("ContactView")}} title="Nous contacter" leadingIcon={"send"}/>
        <Menu.Item onPress={() => {navigation.navigate("AboutUsView")}} title="A propos de nous" leadingIcon={"information"}/>
